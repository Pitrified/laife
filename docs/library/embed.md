...
Source: [`src/laife/embed/`](../../src/laife/embed).

## Sentence-transformers wrapper

[`sentence_transformer_embeddings.py`](../../src/laife/embed/sentence_transformer_embeddings.py) defines `SentenceTransformersEmbeddings`, a LangChain `Embeddings` implementation backed by HuggingFace `sentence-transformers`.
...
[`utils.py`](../../src/laife/embed/utils.py) holds the supporting helpers.

...
Source: [`src/laife/data_models/`](https://github.com/Pitrified/laife/tree/main/src/laife/data_models).

## BaseModelKwargs

[`basemodel_kwargs.py`](https://github.com/Pitrified/laife/blob/main/src/laife/data_models/basemodel_kwargs.py) re-exports `BaseModelKwargs` from `llm_core`.

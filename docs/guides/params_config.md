...
Behavior is keyed on two axes defined in [`params/env_type.py`](https://github.com/Pitrified/laife/blob/main/src/laife/params/env_type.py):
...
[`LaifeParams`](https://github.com/Pitrified/laife/blob/main/src/laife/params/laife_params.py) is the single entry point for project settings.
...
[`LaifePaths`](https://github.com/Pitrified/laife/blob/main/src/laife/params/laife_paths.py) resolves filesystem locations and dispatches on the environment location.
Fixed, project-level locations that do not depend on the environment, such as the static and cache folders, live as constants in [`config/constants.py`](https://github.com/Pitrified/laife/blob/main/src/laife/config/constants.py).

## LLM services

[`LLMServicesParams`](https://github.com/Pitrified/laife/blob/main/src/laife/params/llm_services/__init__.py) holds the settings for the three LLM-facing services:
...
Secret values come only from the environment, loaded from `~/cred/laife/.env` by [`load_env`](https://github.com/Pitrified/laife/blob/main/src/laife/params/load_env.py).

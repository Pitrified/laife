...
#     movement_count: int,
# ) -> None:
#     """Move a player by a delta multiple times with a delay between moves."""
...
# def exit_game() -> NoReturn:
#     """Shutdown the pygame runtime and exit the process."""
#     pygame.quit()
#     sys.exit()


# async def main_loop() -> NoReturn:
#     """Run main async event loop for the minimal pygame demo."""
...
#         if player_queuer.input_queue is None:

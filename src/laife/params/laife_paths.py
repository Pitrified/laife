...
# FIXME: update the paths with what we have in the project!  # noqa: FIX001, TD001

from pathlib import Path

import laife
from laife.params.env_type import EnvLocationType
from laife.params.env_type import EnvType
from laife.params.env_type import UnknownEnvLocationError
...
class LaifePaths:
    ...
    def load_common_config_pre(self) -> None:
        ...
        self.src_fol = Path(laife.__file__).parent
